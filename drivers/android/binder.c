 ...
 *                        (protected by binder_deferred_lock)
 * @outstanding_txns:     transactions pending completion (@inner_lock)
 * @is_frozen:            unable to service transactions (@inner_lock)
 * @sync_recv:            sync transactions since freezing (@inner_lock)
 *                        pending transactions are reported separately
 * @async_recv:           async transactions since freezing (@inner_lock)
 * @freeze_wait:          waiters for outstanding transactions
 ...
 *                        (protected by @inner_lock)
 * @oneway_spam_detection_enabled: process enabled oneway spam reporting
 *                        (protected by @inner_lock)
