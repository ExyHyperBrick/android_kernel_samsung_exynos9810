...
enum bpf_arg_type {
	...
	ARG_PTR_TO_BTF_ID_SOCK_COMMON, /* in-kernel sock_common or bpf_sock */
	...
	ARG_PTR_TO_CONST_STR,	/* read-only NUL-terminated string */
	__BPF_ARG_TYPE_MAX,
};
...
struct bpf_func_proto {
	...
	u32 *ret_btf_id; /* return value BTF ID */
...
static inline void bpf_link_init(struct bpf_link *link,
				 enum bpf_link_type type,
				 const struct bpf_link_ops *ops,
				 struct bpf_prog *prog)
{
