...
struct bpf_insn_aux_data {
	...
	u32 seen; /* this insn was processed at env->pass_cnt */
	bool sanitize_stack_spill; /* subject to Spectre v4 sanitation */
	bool zext_dst; /* this insn zero extends dst reg */
	u8 alu_state; /* used in combination with alu_limit */

	/* The fields below are initialized only once. */
...
static inline bool
bpf_verifier_log_attr_valid(const struct bpf_verifier_log *log, u32 max_len)
{
	return log->len_total >= 128 && log->len_total <= max_len &&
